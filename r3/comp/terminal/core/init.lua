...
local bus           = require("r3.comp.terminal.core.bus")          .instantiate()
local char_control  = require("r3.comp.terminal.core.char_control") .instantiate()
local char_advance  = require("r3.comp.terminal.core.char_advance") .instantiate()
local pixel_control = require("r3.comp.terminal.core.pixel_control").instantiate()
local color_select  = require("r3.comp.terminal.core.color_select") .instantiate()
local cursor_select = require("r3.comp.terminal.core.cursor_select").instantiate()
