...
local range_to_rbits = require("r3.comp.terminal.core.range_to_rbits").instantiate()
local rbits_to_mask  = require("r3.comp.terminal.core.rbits_to_mask") .instantiate()
