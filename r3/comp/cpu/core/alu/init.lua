...
local adder     = require("r3.comp.cpu.core.alu.adder")
local bitwise   = require("r3.comp.cpu.core.alu.bitwise").instantiate()
local shifter   = require("r3.comp.cpu.core.alu.shifter").instantiate()
local csmult    = require("r3.comp.cpu.core.alu.csmult") .instantiate()
local mux       = require("r3.comp.cpu.core.alu.mux")
