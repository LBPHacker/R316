...
local flags_sel      = require("r3.comp.cpu.core.flags_sel")
local unstack_high   = require("r3.comp.cpu.core.unstack_high")  .instantiate()
local stack_high     = require("r3.comp.cpu.core.stack_high")    .instantiate()
local instr_sel      = require("r3.comp.cpu.core.instr_sel")
local pc_incr        = require("r3.comp.cpu.core.pc_incr")       .instantiate()
local pc_sel         = require("r3.comp.cpu.core.pc_sel")        .instantiate()
local sec_sel        = require("r3.comp.cpu.core.sec_sel")       .instantiate()
local state_next     = require("r3.comp.cpu.core.state_next")
local wreg_addr_sel  = require("r3.comp.cpu.core.wreg_addr_sel") .instantiate()
local curr_instr_sel = require("r3.comp.cpu.core.curr_instr_sel")
local ram_addr_sel   = require("r3.comp.cpu.core.ram_addr_sel")  .instantiate()
