...
return testbed.module({
	...
	inputs = {
		...
		{ name = "carry_in"   , index = 5, keepalive = 0x00200000, payload = 0x00000001, initial = 0x00200000 },
	...
	func = function(inputs)
		local lhs_ka = inputs.pri_in:bor(0x3FFF0000):assert(0x3FFF0000, 0x0000FFFF)
		local rhs_ka = inputs.sec_in:bor(0x00010000):assert(0x10010000, 0x0000FFFF)
		local rhs_ka_subtract = rhs_ka:bxor(0x3FFFFFFF):bxor(spaghetti.lshift(0x3FFFFFFF, inputs.subtract_in))
		...
		local propagate_conditional = propagate_shifted:band(spaghetti.lshift(0x3FFFFFFF, inputs.carry_in))
	...
	fuzz = function()
		...
		return {
			inputs = {
				...
				carry_in    = bitx.bor(0x00200000, carry_in),
