...
return testbed.module(function(params)
	...
	return {
		...
		inputs = {
			...
			{ name = "flags"     , index = 16 - mcore_offset, keepalive = 0x10000000, payload = 0x0000000F,                    initial = 0x1000000B },
		...
		outputs = {
			...
			{ name = "flags"     , index = 16 - mcore_offset, keepalive = 0x10000000, payload = 0x0000000F                    },
